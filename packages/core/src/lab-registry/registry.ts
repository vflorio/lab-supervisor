...
// Dominio applicativo (supervisor): quali device della rete ci interessano, con che label
// mostrarli e se attualmente controllati, indipendentemente dai dati Suitest. Il legame verso
// Suitest è la foreign key opzionale `videoCaptureDeviceId`/`ip` di ciascuna entry (tranne
// candybox/tv, la cui identità coincide con l'id Suitest).
