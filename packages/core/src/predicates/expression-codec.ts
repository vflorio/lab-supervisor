...
import type { FactLeaf, PredicateExpression } from "./expression";
...
export const PredicateExpressionCodec: t.Type<PredicateExpression, unknown[], unknown> = booleanTreeCodec(
  "PredicateExpression",
  FactLeafCodec,
);
